...
public abstract class TestBase {
    ...
    /*
       TestBase class is used for calling repeated pre-conditions and post-conditions
       Make the driver protected because it should be visible in the other classes

       TestBase will be extended by other test classes and @Before and @After methods will be implemented automatically
     */
    ...
    /*
       ...
       Create AfterAll for generate the reports by using flush
     */
    @BeforeAll
    public static void setExtentReports(){
        ...
        //ATTACH extent report and html reporter
    ...
    public static void flushExtentReports(){
        //required for generating report
        extentReports.flush();
    }
    ...
    //DROPDOWN
    //Create a method that select an option from a dropdown by index
    ...
    public static void webTableDataFinder(int row, int column){
        String tableElement = driver.findElement(By.xpath("//table[@id='table1']//tr[" + row + "]//td[" + column + "]")).getText();
    ...
    //    ACTIONS_HOVER_OVER
    public static void actionsHoverOverOnElementActions(WebElement element) {
        //        Actions actions = new Actions(driver);
        new Actions(driver).moveToElement(element).perform();
    }
    //    ACTIONS_SCROLL_DOWN
    public static void actionsScrollDownActions() {
        //        Actions actions = new Actions(driver);
        new Actions(driver).sendKeys(Keys.PAGE_DOWN).perform();
    }
    //    ACTIONS_SCROLL_UP
    public static void actionsScrollUpActions() {
        //        Actions actions = new Actions(driver);
        new Actions(driver).sendKeys(Keys.PAGE_UP).perform();
    }
    //    ACTIONS_SCROLL_RIGHT
    public static void actionsScrollRightActions(){
        new Actions(driver).sendKeys(Keys.ARROW_RIGHT).sendKeys(Keys.ARROW_RIGHT).perform();
    }
    //    ACTIONS_SCROLL_LEFT
    public static void actionsScrollLeftActions(){
        new Actions(driver).sendKeys(Keys.ARROW_LEFT).sendKeys(Keys.ARROW_LEFT).perform();
    }
    //    ACTIONS_DRAG_AND_DROP
    public static void actionsDragAndDropActions(WebElement source, WebElement target) {
        //        Actions actions = new Actions(driver);
        new Actions(driver).dragAndDrop(source,target).perform();
    }
    //    ACTIONS_DRAG_AND_DROP_BY
    public static void actionsDragAndDropActions(WebElement source, int x, int y) {
        //        Actions actions = new Actions(driver);
  ...
  */
    ...
    */
    ...
    //ROBOT UPLOAD FILE
    public static void uploadFileByRobot(String pathOfFile){
        try {
            waitFor(1);
    ...
    // SCREENSHOTS: capture the screenshot of a specific element
    ...
    public static String captureScreenShotEntirePageAsString(){
        ...
        //4. return also the path of the image as string (THIS WILL BE USED TO ATTACH IN THE EXTENT REPORTS)
